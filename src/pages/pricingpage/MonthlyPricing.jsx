    ...
    <div>
        ...
        <div className='w-[340px] h-[450px] border rounded-[25px] py-3 p-3'>
            <div className='text-center'>
                <h1>Free</h1>
                <h1 className='text-[40px] mb-3'>$0 <span className='text-[15px] font-extralight'>per user/month</span></h1>
        ...
        <div className='w-[340px] h-[450px] border  rounded-[25px] py-3 p-3'>
            <div className='text-center'>
                <h1>Pro</h1>
            <h1 className='text-[40px] mb-3'>$29 <span className='text-[15px] font-extralight'>per user/month</span></h1>
        ...
        <div className='w-[340px] h-[450px] border rounded-[25px] py-3 p-3'>
            ...
            <div className='text-center'>
                <h1>Ultra Pro</h1>
            <h1 className='text-[40px] mb-3'>$59 <span className='text-[15px] font-extralight'>per user/month</span></h1>
